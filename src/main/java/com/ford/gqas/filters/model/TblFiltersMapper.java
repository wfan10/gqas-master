...
public class TblFiltersMapper implements RowMapper<TblFiltersDTO> {

	public TblFiltersDTO mapRow(ResultSet rs, int rowNum) throws SQLException {

		TblFiltersDTO filterRow = new TblFiltersDTO();
		filterRow.setGroupId(rs.getLong("GROUP_ID"));
		filterRow.setGroupName(rs.getString("GROUP_NAME"));
